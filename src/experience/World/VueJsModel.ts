...
export default class VueJsModel implements OnUpdateTriggerInterface
{
    ...
    constructor() {
        ...
        if (this.debug.active) {
            this.debugModel = this.debug.ui.addFolder('vuejsModel')
        }
        // @ts-ignore
        this.resource = this.resources.items.vuejsModel
        this.buildModel()
    }
