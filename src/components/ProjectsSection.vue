...
<template>
  <section id="project-section" class="bg-primary projects text-slate-50">
    <div class="container mx-auto py-24">
      ...
      <div class="w-6/12 mx-auto border-secondary border-2 py-4 px-6 flex rounded-xl cursor-pointer justify-between" @click="toggleSearchMenu">
        <span>Rechercher un projet</span>
        <div class="flex items-center text-secondary">
          <KeyboardCommand img-class="fill-white" class="mr-1" />K
        </div>
      </div>
    </div>
